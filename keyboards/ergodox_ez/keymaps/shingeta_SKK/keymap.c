...
#define SGTA 3 // shingeta layer
#define SGTS 4 // shingeta(shifted) layer
...
[BASE] = LAYOUT_ergodox(
  ...
  KC_DEL,          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    TG(SGTA),
...
[SYMB] = LAYOUT_ergodox(
  // left hand
  SGTA_TEST, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TRNS,
  KC_TRNS,   KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS,
  KC_TRNS,   KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,
  KC_TRNS,   KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS,
  EPRM,      RESET,   KC_TRNS, KC_TRNS, KC_TRNS,
                                                 RGB_MOD, KC_TRNS,
                                                          KC_TRNS,
...
[SGTA] = LAYOUT_ergodox(  // layer 4 : shin geta
        ...
        KC_TRNS, CS_SGKEY, CS_SGKEY, CS_SGKEY, CS_SGKEY, CS_SGKEY, KC_TRNS,
        KC_TRNS, CS_SGKEY, CS_SGKEY, CS_SGKEY, CS_SGKEY, CS_SGKEY,
...
[SGTS] = LAYOUT_ergodox(  // layer 4 : shift on shin geta
        // left hand
        ...
        KC_TRNS, CS_SGKEY_S, CS_SGKEY_S, CS_SGKEY_S, CS_SGKEY_S, CS_SGKEY_S,
